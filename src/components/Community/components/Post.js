...
import likeIcon from '../pic/like2.png';
      ...
      <div className="post-actions">
        <div className="action-item" onClick={handleLike}>
          {/* <img
            ...
            style={{
            filter: isLiked ? 'brightness(0) saturate(100%) invert(28%) sepia(93%) saturate(7471%) hue-rotate(348deg) brightness(101%) contrast(107%)' : 'none'
            }}
          /> */}
